...
$DownloadUrl = "https://github.com/BuckshotPlusPlus/cli/releases/latest/download/windows.zip"

$InstallDir = "${Home}\.bpp"
$ArchivePath = "${InstallDir}\windows.zip"

$BinDir = "${InstallDir}\bin"
$BinPath = "${InstallDir}\bpp.exe"
...
Write-Output "Successfully installed bpp to ${BinPath}"
Write-Output "Run 'bpp --help' to get started!"
